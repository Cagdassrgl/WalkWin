...
class LoginViewConst {
  static Widget loginView(
    Size size,
    ...
    return Wrap(
      children: [
        ...
        RadiusTextFormField(
          ...
          padding: EdgeInsets.fromLTRB(size.width * 0.10, size.height * 0.02,
              size.width * 0.10, size.height * 0.01),
        ),
        RadiusTextFormField(
          ...
          child: CustomButton.button(
            ...
            onPressed: () {
              if (loginViewModel.email.text.isEmpty &&
                ...
                authService
                    .signIn(
                        loginViewModel.email.text, loginViewModel.password.text)
                    .then(
                  (value) {
                    if (value != null) {
        ...
        Center(
          child: Padding(
            padding: EdgeInsets.fromLTRB(
                size.width * 0.20, size.height * 0.02, size.width * 0.20, 0),
            child: TextButton(
              child: Text(
